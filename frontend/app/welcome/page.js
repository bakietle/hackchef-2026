...
export default function WelcomePage() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'var(--cream)', display:'flex', flexDirection:'column', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', padding:'14px 24px', borderBottom:'1.5px solid var(--border)' }}>
        <div style={{ display:'flex', alignItems:'center', gap:8 }}>
          <div style={{ width:30, height:30, background:'var(--navy)', borderRadius:9, display:'flex', alignItems:'center', justifyContent:'center', fontSize:16 }}>🍳</div>
          <span style={{ fontFamily:'Fraunces, serif', fontSize:17, fontWeight:900, color:'var(--navy)', letterSpacing:'-0.3px' }}>nomster</span>
        </div>
        <div style={{ background:'var(--navy)', color:'var(--yellow)', padding:'4px 12px', borderRadius:20, fontSize:10, fontWeight:800, letterSpacing:1 }}>UNIHACK 2026</div>
      </div>
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'24px 28px 32px', textAlign:'center' }}>
        ...
        <h1 style={{ fontFamily:'Fraunces, serif', fontSize:36, fontWeight:900, color:'var(--navy)', lineHeight:1.05, marginBottom:8, letterSpacing:'-0.5px' }}>
          Your AI<br/>
        ...
        <div style={{ width:'100%', maxWidth:340, background:'var(--white)', border:'2px solid var(--navy)', borderRadius:20, padding:'20px 18px', boxShadow:'var(--shadow-md)' }}>
          ...
          <input
            style={{ width:'100%', background:'var(--paper)', border:'2px solid var(--border)', borderRadius:12, padding:'13px 14px', fontSize:15, fontFamily:'Nunito, sans-serif', outline:'none', fontWeight:700, color:'var(--navy)', marginBottom:12 }}
      ...
      <div style={{ textAlign:'center', padding:'12px 20px 20px', borderTop:'1.5px solid var(--border)', fontSize:11, color:'var(--muted)', fontWeight:600 }}>
        Made with 💛 at UNIHACK 2026 · Melbourne
      </div>
    </div>
  )
}
